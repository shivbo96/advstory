      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: widget.onTapTray != null && widget.buildHelper.stories[index]?.contentCount == 0
                ? () => widget.onTapTray?.call(index)
                : (() {
                    if (widget.buildHelper.stories[index]?.contentCount == 0) {
                      widget.onTapTray?.call(index);
                      return;
                    }
                    _handleTrayTap(
            ...
            onLongPress: widget.onLongPressTray != null ? () => widget.onLongPressTray!(index) : null,
            child: tray,
          );
        },
